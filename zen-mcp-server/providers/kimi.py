...
class KimiModelProvider(OpenAICompatibleProvider):
    ...
    SUPPORTED_MODELS = {
        ...
        "kimi-k2-turbo-preview": ModelCapabilities(
            ...
            supports_extended_thinking=False,
            temperature_constraint=RangeTemperatureConstraint(0.0, 1.0, 0.3),
            description="High-speed K2 variant (official preview) with ~128K context",
    ...
    def generate_content(self, prompt: str, model_name: str, **kwargs) -> ModelResponse:
        ...
        # Map the resolved base key to the canonical provider model name expected by Moonshot API
    ...
    def upload_file(self, file_path: str, purpose: str = "assistants") -> str:
        ...
        Args:
            ...
            purpose: Provider-specific purpose tag (default 'assistants')
        ...
        try:
            with open(file_path, "rb") as f:
                ...
                file_id = getattr(result, "id", None) or result.get("id")
                if not file_id:
